...
const val SettingVersion = "현재 버전 %s"
const val SettingLogOut = "로그아웃"
const val SettingDeleteUser = "회원 탈퇴"
const val SettingDeleteUserTitleBeforeWord = "소프티를 정말 "
const val SettingDeleteUserTitleWord = "탈퇴"
const val SettingDeleteUserTitleAfterWord = "하시나요?"
const val SettingDeleteUserSemiTitle = "탈퇴하면 계정이 삭제되고 모든 데이터가 사라집니다."
