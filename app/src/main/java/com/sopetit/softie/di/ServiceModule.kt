...
object ServiceModule {
    ...
    fun provideAuthService(
        @SoftieRetrofit retrofit: Retrofit,
    ): AuthService {
    ...
    @Provides
    fun provideMemberRoutineService(
        @SoftieRetrofit retrofit: Retrofit,
    ...
    @Provides
    fun provideMemberChallengeService(
        @SoftieRetrofit retrofit: Retrofit,
    ...
    @Provides
    fun provideCustomRoutineService(
        @SoftieRetrofit retrofit: Retrofit,
