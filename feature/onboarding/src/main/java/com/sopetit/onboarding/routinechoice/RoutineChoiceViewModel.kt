...
class RoutineChoiceViewModel
    ...
    constructor(
        ...
        private fun onSuccessGetDailyRoutine(data: DailyRoutineListThemeTotalModel) {
            ...
            val chipThemeList: List<SelectedThemeItem> =
                listOf(
        ...
        private fun mapSelectedThemeItem(
            routines: List<DailyRoutineListModel>,
            index: Int,
        ) =
            with(routines) {
                SelectedThemeItem(
        ...
        fun setSelectedThemeId(themeId: Int) {
            updateState(
                uiState.value.copy(
                    ...
                    eachThemeRoutineList =
                        uiState.value.routineTotalList.find { it.themeId == themeId }?.routines
                            ?: emptyList(),
                ),
            )
        }
